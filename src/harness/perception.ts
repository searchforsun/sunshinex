...
export const SCAN_SKIP_DIRS = new Set(['node_modules', 'dist', '.git', '.pnpm-store', '.npm-cache', '.data', '.data-test', '.sunshinex', '.cursor', '.codex', '.claude', '.agents', '.superpowers', '.longtask', '.corepack']);
